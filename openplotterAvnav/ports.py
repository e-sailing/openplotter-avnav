...
# Copyright (C) 2023 by Sailoog <https://github.com/openplotter/openplotter-sdr-vhf>
# Copyright (C) 2023 by e-sailing <https://github.com/e-sailing/openplotter-sdr-vhf>
# 
